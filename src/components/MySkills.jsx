...
import { SiExpress, SiMongodb, SiMysql,SiFormik, SiPostman } from "react-icons/si";
...
const skills = [
  ...
  { name: "MySQL", icon: <SiFormik />, color: "text-blue-500 group-hover:text-blue-600" },
  { name: "MySQL", icon: <IoPrismSharp />, color: "text-blue-500 group-hover:text-blue-600" },
  { name: "MySQL", icon: <SiPostman />, color: "text-red-400 group-hover:text-red-300" },
  { name: "MySQL", icon: <RiTailwindCssFill />, color: "text-blue-500 group-hover:text-blue-600" },
